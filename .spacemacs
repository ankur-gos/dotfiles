...
you should place your code here."
  (setq org-todo-keywords
        '((sequence "TODO" "IN PROGRESS" "NEEDS REVISIT" "|" "DONE" )))
  (setq org-lowest-priority ?E)
  (setq org-default-priority ?E)
  
  (setq org-agenda-files (list "~/Dropbox/Papers/AllNotes.org"
                               "~/Dropbox/organizer.org"))
